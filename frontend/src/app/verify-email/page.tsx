      ...
      <section className="max-w-md mx-auto bg-white shadow-md rounded-lg p-6">
        ...
        <div className="text-center">
          ...
          <div className="text-gray-700 mb-4">
            {email ? (
              <>
                We have sent a verification email to <span className="font-semibold">{email}</span>. Please check your inbox and click on the verification link to activate your account.
              </>
            ) : (
          ...
          <div className="text-sm text-gray-500">
            ...
            <button onClick={resendVerificationEmail} className="text-blue-500 underline">
